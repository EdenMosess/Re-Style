...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center  mb-5">
            <div class="col-md-10">
                <h1 class="mt-5 fancy text-white mb-3">All Categories
                <span class="float-right">
                    <button data-toggle="modal" data-target="#exampleModal" class="btn btn-success btn-sm" >Add New Category</button>
                </span>
                </h1>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="" method="post" onsubmit="return confirm('Are you sure?')">
                           <a href="sub-categories.php?id=<?php echo $category['id']; ?>" class="btn btn-success btn-sm">Sub Categories</a>
